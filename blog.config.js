...
const BLOG = {
  ...
  AUTHOR: 'Paprikalang', // 您的昵称 例如 tangly1024
  BIO: '仰观宇宙之大', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://paprikalang.site', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/paprikalang', // 你的github个人主页 例如 https://github.com/tangly1024
